...
public class Cpp implements Language {
    ...
    String KEYWORDS[] = new String[]{"alignas",
        "alignof", "and", "and_eq", "bitand",
        "bitor", "catch", "compl", "constexpr",
        "const_cast", "decltype", "delete", "dynamic_cast",
        "false", "final", "friend", "new",
        "noexcept", "not", "not_eq", "nullptr",
        "operator", "or", "or_eq", "override",
        "private", "protected", "public", "reinterpret_cast",
        "static_assert", "static_cast", "this", "thread_local",
        "throw", "true", "try", "typeid",
        "using", "xor", "xor_eq", "class",
        "namespace", "typename", "template", "virtual", "asm", "break", "case", "continue", "default", "do", "else", "enum", "for", "fortran", "goto", "if", "return", "struct", "switch", "typedef", "union", "while"};
    String OPERATORS[] = new String[]{"(_A|a)lignof", "_Generic", "offsetof", "(_S|s)tatic_assert", "sizeof", "typeof"};
    String TYPES[] = new String[]{"bool", "char16_t", "char32_t", "explicit", "export", "inline", "mutable", "nullptr_t", "wchar_t", "_Bool", "_Complex", "_Imaginary", "bool", "char", "char(16|32)_t", "double", "float", "int", "(u)?int(_least|_fast)?(8|16|32|64)_t", "(u)?intmax_t", "(u)?intptr_t", "long", "ptrdiff_t", "off(64)?_t", "short", "signed", "size_t", "ssize_t", "unsigned", "void", "wchar_t", "wint_t"};
    ...
    String COMMON_DEFINES[] = new String[]{"__STDC__",
        "__cplusplus", "null", "MAX", "MIN", "true", "false", "__LINE__", "__DATA__", "__FILE__", "__func__", "__TIME__", "__STDC__"};
