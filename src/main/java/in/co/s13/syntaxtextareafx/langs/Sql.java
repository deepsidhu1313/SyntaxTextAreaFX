...
public class Sql implements Language {
    ...
    String ORACLE_BUILT_IN_DATATYPES[] = new String[]{"N?VARCHAR2", "NUMBER", "LONG", "DATE", "TIMESTAMP", "INTERVAL", "(LONG[ \\t\\n]+)?RAW", "U?ROWID", "N?CHAR", "(N?C|B)LOB", "BFILE", "BINARY_(FLOAT|DOUBLE)"};
    ...
    public Pattern generatePattern() {
        ...
        String ORACLE_BUILT_IN_DATATYPES_PATTERN = "\\b(" + String.join("|", ORACLE_BUILT_IN_DATATYPES) + ")\\b";
        String ANSI_DATATYPES_PATTERN = "\\b(" + String.join("|", ANSI_DATATYPES) + ")\\b";
        String SQL_DS_AND_DB2_DATATYPES_PATTERN = "\\b(" + String.join("|", SQL_DS_AND_DB2_DATATYPES) + ")\\b";
        String ORACLE_SUPPLIED_TYPES_PATTERN = "\\b(" + String.join("|", ORACLE_SUPPLIED_TYPES) + ")\\b";
        String UNLIMITED_PATTERN = "\\b(" + String.join("|", UNLIMITED) + ")\\b";
        String NULL_PATTERN = "\\b(" + String.join("|", NULL) + ")\\b";
        String NUMERIC_FUNCTIONS_PATTERN = "\\b(" + String.join("|", NUMERIC_FUNCTIONS) + ")\\b";
        String CHARACTER_FUNCTIONS_RETURNING_CHARACTER_VALUES_PATTERN = "\\b(" + String.join("|", CHARACTER_FUNCTIONS_RETURNING_CHARACTER_VALUES) + ")\\b";
        String NLS_CHARACTER_FUNCTIONS_PATTERN = "\\b(" + String.join("|", NLS_CHARACTER_FUNCTIONS) + ")\\b";
        String CHARACTER_FUNCTIONS_RETURNING_NUMBER_VALUES_PATTERN = "\\b(" + String.join("|", CHARACTER_FUNCTIONS_RETURNING_NUMBER_VALUES) + ")\\b";
        String DATETIME_FUNCTIONS_PATTERN = "\\b(" + String.join("|", DATETIME_FUNCTIONS) + ")\\b";
        String GENERAL_COMPARISON_FUNCTIONS_PATTERN = "\\b(" + String.join("|", GENERAL_COMPARISON_FUNCTIONS) + ")\\b";
        String CONVERSION_FUNCTIONS_PATTERN = "\\b(" + String.join("|", CONVERSION_FUNCTIONS) + ")\\b";
        String LARGE_OBJECT_FUNCTIONS_PATTERN = "\\b(" + String.join("|", LARGE_OBJECT_FUNCTIONS) + ")\\b";
        String COLLECTION_FUNCTIONS_PATTERN = "\\b(" + String.join("|", COLLECTION_FUNCTIONS) + ")\\b";
        String HIERARCHICAL_FUNCTION_PATTERN = "\\b(" + String.join("|", HIERARCHICAL_FUNCTION) + ")\\b";
        String DATA_MINING_FUNCTIONS_PATTERN = "\\b(" + String.join("|", DATA_MINING_FUNCTIONS) + ")\\b";
        String XML_FUNCTIONS_PATTERN = "\\b(" + String.join("|", XML_FUNCTIONS) + ")\\b";
        String ENCODING_AND_DECODING_FUNCTIONS_PATTERN = "\\b(" + String.join("|", ENCODING_AND_DECODING_FUNCTIONS) + ")\\b";
        String NULL_RELATED_FUNCTIONS_PATTERN = "\\b(" + String.join("|", NULL_RELATED_FUNCTIONS) + ")\\b";
        String ENVIRONMENT_AND_IDENTIFIER_FUNCTIONS_PATTERN = "\\b(" + String.join("|", ENVIRONMENT_AND_IDENTIFIER_FUNCTIONS) + ")\\b";
        String AGGREGATE_FUNCTIONS_PATTERN = "\\b(" + String.join("|", AGGREGATE_FUNCTIONS) + ")\\b";
        String ANALYTIC_FUNCTIONS_PATTERN = "\\b(" + String.join("|", ANALYTIC_FUNCTIONS) + ")\\b";
        String OBJECT_REFERENCE_FUNCTIONS_PATTERN = "\\b(" + String.join("|", OBJECT_REFERENCE_FUNCTIONS) + ")\\b";
        String MODEL_FUNCTIONS_PATTERN = "\\b(" + String.join("|", MODEL_FUNCTIONS) + ")\\b";
        String ANSI_RESERVED_WORDS_PATTERN = "\\b(" + String.join("|", ANSI_RESERVED_WORDS) + ")\\b";
        String ORACLE_RESERVED_WORDS_PATTERN = "\\b(" + String.join("|", ORACLE_RESERVED_WORDS) + ")\\b";
        String SQL_STATEMENTS_PATTERN = "\\b(" + String.join("|", SQL_STATEMENTS) + ")\\b";
        String OPERATORS_PATTERN = "\\b(" + String.join("|", OPERATORS) + ")\\b";
        String CONDITIONS_PATTERN = "\\b(" + String.join("|", CONDITIONS) + ")\\b";
        String SQL_PLUS_COMMANDS_PATTERN = "\\b(" + String.join("|", SQL_PLUS_COMMANDS) + ")\\b";
    ...
    public String getStyleClass(Matcher matcher) {
        return matcher.group("STRING") != null ? "string"
                ...
                : matcher.group("ORACLEBUILTINDATATYPES") != null ? "oracle-built-in-datatypes"
