...
/**
 * Line-marker highlighting for unified/context diff output — additions, removals
 * and hunk headers. No keyword, string or comment rules; diff output doesn't have them.
 *
